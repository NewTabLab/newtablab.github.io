<template>
  <div class="grid grid-cols-2 font-light md:grid-cols-3 font-dosis">
    <div class="flex items-center justify-center">
      <svg
        viewBox="0 0 1856.41 1903.46"
        class="w-20 h-20 md:w-40 md:h-40 animate-wiggle"
        title="Logo"
      >
        <defs>
    ...
    <div class="flex flex-col items-center justify-center mt-4 lg:mt-0">
      <h1 class="text-3xl font-thin text-gray-500 sm:text-5xl">
        TA<span class="font-medium text-gray-800"
          >RI<span class="font-bold text-black">KK</span>AV</span
        >AZ
      </h1>
      <h3 class="text-xl text-gray-500 sm:text-3xl">Designer & Coder</h3>
    </div>
    <div
      class="flex items-center justify-center col-span-2 mt-10  md:col-span-1 lg:mt-0"
    >
      <div class="grid grid-cols-6 gap-6">
        ...
        <a
          href="http://www.linkedin.com/in/tarikkavaz"
          target="_blank"
          class="has-tooltip"
        >
          <span class="tooltip"
